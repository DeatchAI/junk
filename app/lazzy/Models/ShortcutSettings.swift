...
struct ShortcutSettings {
  ...
  private enum Keys {
    ...
    static let resumeLastChatCode = "shortcut_rlc_code"
    static let resumeLastChatMods = "shortcut_rlc_mods"
  ...
  static let defaultResumeLastChat = KeyShortcut(keyCode: kVK_ANSI_R, modifiers: optionKey | shiftKey)
  ...
  /// Reopens the most recently active floating task without creating another
  /// agent conversation. Kept separate from `floatingChat`, which is a new-task launcher.
  static var resumeLastChat: KeyShortcut {
    get {
      KeyShortcut(
        keyCode: UserDefaults.standard.integer(forKey: Keys.resumeLastChatCode) == 0
          && UserDefaults.standard.object(forKey: Keys.resumeLastChatCode) == nil
          ? defaultResumeLastChat.keyCode
          : UserDefaults.standard.integer(forKey: Keys.resumeLastChatCode),
        modifiers: UserDefaults.standard.object(forKey: Keys.resumeLastChatMods) == nil
          ? defaultResumeLastChat.modifiers
          : UserDefaults.standard.integer(forKey: Keys.resumeLastChatMods))
    }
    set {
      UserDefaults.standard.set(newValue.keyCode, forKey: Keys.resumeLastChatCode)
      UserDefaults.standard.set(newValue.modifiers, forKey: Keys.resumeLastChatMods)
    }
  }
  ...
  static func resetToDefaults() {
    ...
    resumeLastChat = defaultResumeLastChat
