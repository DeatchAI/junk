        ...
        VStack(alignment: .leading, spacing: 24) {
          ...
          HStack(spacing: 12) {
            ...
            SettingsPageHeader(
              ...
              subtitle: "Connect a local command or remote endpoint to Detach."
            )
          }
        ...
        VStack(alignment: .leading, spacing: 20) {
          VStack(alignment: .leading, spacing: 16) {
            SettingsPageHeader(
              ...
              subtitle: "Give Detach access to additional tools and data through built-in integrations or your own MCP servers."
            )
