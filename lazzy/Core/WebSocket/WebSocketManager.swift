...
class WebSocketManager: ObservableObject {
  ...
  private func syncBrowserSettingsOnConnect() {
    ...
    if BrowserSettings.useDailyDriverProfile && !BrowserSettings.userDataDir.isEmpty {
  ...
  func updateBrowserSettings(
    cdpUrl: String?, headless: Bool?, viewportWidth: Int?, viewportHeight: Int?,
  ...
  private func handleSecretCommand(
    ...
    do {
      ...
      case "secrets.use_browser":
        ...
        try await secretVault.fillBrowserCredential(id: credentialId, origin: origin)
        sendSecretCommandResult(id: id, ok: true, resultJson: "{\"filled\":true}")
